            ...
            <div class="row">
                <div class="col-lg-8 offset-lg-2">
                    <div class="site-heading">
                        <h2 class="title">Working for dubai <br> since 2010</h2>
                        <div class="row">
        ...
        <div class="container">
            <div class="row align-center">
                <div class="col-lg-4">
                    ...
                    <a class="btn btn-theme secondary mt-10 btn-md radius animation" href="about-us.php">Meet all Farmers</a>
                </div>
