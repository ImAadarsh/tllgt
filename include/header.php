            ...
            <div class="container d-flex justify-content-between align-items-center">
                ...
                <div class="navbar-brand-left">
                    ...
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="index.php">
                            <img src="images/gt-logo.png" class="logo" alt="Logo">
                        </a>
                    </div>
                ...
                <div class="collapse navbar-collapse" id="navbar-menu">
                    ...
                    <ul class="nav navbar-nav navbar-right" data-in="fadeInDown" data-out="fadeOutUp">
                        <li class="dropdown">
                            <a href="index.php" class=" active" data-toggle="dropdown" >Home</a>
                        
                        </li>
                        <li class="dropdown">
                            <a href="products.php" class=" " data-toggle="dropdown" >Products</a>
                        
                        </li>
                        <li class="dropdown">
                            <a href="about-us.php" class=" " data-toggle="dropdown" >About Us</a>
                        
                        </li>
                        <li class="dropdown">
                            <a href="contact.php" class=" " data-toggle="dropdown" >Contact </a>
